...
export function StageCaption() {
  ...
  /**
   * Под нижними плашками титров нет.
   *
   * Плашки целевого образа и итога занимают нижнюю часть кадра и сами несут
   * все заголовки. Строка титров под ними повторяла бы третьим шрифтом то же
   * самое и отъедала последние сантиметры, которых плашке и так в обрез.
   */
  if (beat.panel === 'intro' || beat.panel === 'effects') return null;
