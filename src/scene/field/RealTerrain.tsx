 ...
 *
 * БАЛАНС ЯРКОСТИ И ЦВЕТА. Шкала прошла через две крайности. Светлая версия
 * перетягивала внимание, и трассы сетей в ней тонули. Затем я увёл её почти в
 * чёрное — трассы читаться стали, но вместе с цветом ушла и земля: сцена
 * получилась чёрно-белой, а степь на Прикаспии не чёрная.
 *
 * Здесь середина: светлота держится в средне-тёмной зоне, чтобы насыщенные
 * янтарь и синь трубопроводов оставались ярче фона, но насыщенность вернулась.
 * Ход от прохладного серо-коричневого в понижениях, где держится суглинок, к
 * песчаной охре на гривах, где грунт выдут до песка.
 */
