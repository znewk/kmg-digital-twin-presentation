...
> = {
  ...
  nedra: {
    ...
    note: 'Продукты Nedra Digital, закрывающие разрывы ABAI',
  },
  ext: {
    label: 'Внешние',
...
const RAW = {
  ...
  abaiCb: {
    ...
    source: 'abai',
    status: 'broken',
    what: 'модуль цифрового бурения — в продакшене не используется',
  },
  abaiTkrs: {
    id: 'abaiTkrs',
    nameNedra: 'ABAI · ТКРС',
    ...
    source: 'abai',
    status: 'broken',
    what: 'мониторинг ТКРС — восстановление в плане до конца года',
  },
