  ...
  return (
    <div ref={box} className="plate-in panel pointer-events-auto absolute inset-x-8 bottom-8 flex max-h-[54%] flex-col gap-2.5 overflow-hidden px-5 py-3.5">
      ...
      {/*
        ...
        Переход не мгновенный: камера снижается с орбиты к Молдабеку тем же
        подлётом, каким раньше заканчивалась гео-последовательность, и промысел
        поднимается под заслонкой в конце снижения (см. `entry` в сторе).
      */}
