  ...
  return (
    <div className="fixed inset-0">
      <Canvas
        ...
        // километров. При прежних 6000 всё поле оказывалось за плоскостью
        // отсечения и сцена была пустой.
        //
        // Ближняя плоскость критична: точность буфера глубины падает как
        // d²/(near·2²⁴). При near = 1 на дистанции 7 км шаг составлял 2,9 м, и
        // трассы труб, поднятые над рельефом на 2,5 м, проигрывали ему по
        // глубине и исчезали. При near = 10 шаг там же — 0,29 м. Ближе десяти
        // метров камера не подходит: минимум орбиты 20 м, наведение на
        // скважину садится на 45 м.
        camera={{ fov: 38, near: 10, far: 25000, position: [0, 34, 128] }}
        onCreated={({ gl, scene }) => {
