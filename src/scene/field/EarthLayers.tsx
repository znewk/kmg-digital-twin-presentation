...
export function EarthLayers() {
  ...
  return (
    /*
      Секущая плоскость режет ЭТО поддерево и больше ничего.
      Разрез убирает непрозрачную породу, чтобы стало видно скважины, приток и
      подземное оборудование, — а не их самих вместе с ней.
    */
    <group userData={{ clipTarget: true }}>
      {strata.map((s) => {
