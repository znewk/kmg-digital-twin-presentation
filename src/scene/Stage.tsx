...
export function Stage() {
  ...
  /**
   * В разборе модуля сцена перестаёт ловить курсор.
   *
   * Кадр поставлен и объекты подсвечены — случайный клик по соседней качалке
   * увёл бы камеру на другой конец промысла и открыл карточку, к разбираемому
   * модулю отношения не имеющую. Ведёт здесь раздел, а не мышь.
   *
  ...
  return (
    <div className="fixed inset-0">
      <Canvas
        style={{ pointerEvents: dive ? 'none' : 'auto' }}
