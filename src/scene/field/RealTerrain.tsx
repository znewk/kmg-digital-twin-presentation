...
export function TerrainContours() {
  ...
  return (
    <lineSegments geometry={geometry} userData={{ id: 's-contours' }}>
      ...
      */}
      {/* Горизонтали приглушены обратно: они справочный слой, и конкурировать
          с трассами сетей за внимание им незачем. */}
      <lineBasicMaterial color="#8fa6bb" transparent opacity={0.26} depthWrite={false} />
    </lineSegments>
  );
}
