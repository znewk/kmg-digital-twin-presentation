...
/**
 * Станки-качалки красят — обычно в один цвет по всему промыслу. Балансир
 * светлее, кривошип с противовесами темнее и тёплее: противовесы чугунные и
 * ржавеют, их подкрашивают чаще и грубее.
 *
 * Шестьсот одинаково стальных качалок делали промысел чёрно-белым; окраска
 * возвращает ему живость, оставаясь приглушённой — насыщенные цвета в палитре
 * §8.1 заняты смыслом, а не железом.
 */
